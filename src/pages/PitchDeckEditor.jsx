...
export default function PitchDeckEditor() {
  ...
  const generateNarration = async () => {
    ...
    const { data: result, error: genError } = await supabase.functions.invoke('generatePitchSpeech', { body: { project_id: projectId, section_id: selected.id, voice: narrationVoice, language_code: project.original_language || 'en' } });
