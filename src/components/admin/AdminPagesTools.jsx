...
function SectionTabs({ active, onChange }) {
  return <div className="grid grid-cols-2 gap-2 rounded-2xl bg-white/5 p-1.5">
    {[[Code2, 'code', 'Code'], [Settings2, 'configuration', 'Configuration']].map(([Icon, key, text]) =>
...
function ConfigurationSection({ surface, draft, setDraft }) {
  ...
  return <div className="space-y-4">
    ...
    {surface.type === 'tool' && surface.key === 'new_set' && <VaultIconEditor value={config.icon_image || ''} onChange={(url) => update('icon_image', url)} />}
